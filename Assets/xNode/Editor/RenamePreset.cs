...
namespace XNodeEditor
{
    ...
    public class RenamePreset : EditorWindow
    {
        public static RenamePreset current { get; private set; }
        ...
        public static RenamePreset Show(Object target, float width = 200)
        {
            RenamePreset window = EditorWindow.GetWindow<RenamePreset>(true, "Rename " + target.name, true);
