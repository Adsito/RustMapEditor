...
public class PaintSlopeNode : Node
{
    ...
    public void RunNode()
    {
        ...
        {
            case 0:
                MapManager.PaintSlopeBlend(LandLayers.Ground, slopeLow, slopeHigh, slopeMinBlendLow, slopeMaxBlendHigh, TerrainSplat.TypeToIndex(layer.GroundTexture));
                break;
            case 1: 
                MapManager.PaintSlopeBlend(LandLayers.Biome, slopeLow, slopeHigh, slopeMinBlendLow, slopeMaxBlendHigh, TerrainBiome.TypeToIndex(layer.BiomeTexture));
                break;
            case 2: 
                MapManager.PaintSlope(LandLayers.Alpha, slopeLow, slopeHigh, layer.AlphaTexture);
                break;
            case 3: 
                MapManager.PaintSlope(LandLayers.Topology, slopeLow, slopeHigh, layer.TopologyTexture, layer.TopologyLayer);
                break;
        }
    }
}