...
public class PaintHeightNode : Node
{
    ...
    public void RunNode()
    {
        ...
        {
            case 0: 
                MapManager.PaintHeightBlend(LandLayers.Ground, heightLow, heightHigh, heightMinBlendLow, heightMaxBlendHigh, TerrainSplat.TypeToIndex(layer.GroundTexture));
                break;
            case 1: 
                MapManager.PaintHeightBlend(LandLayers.Biome, heightLow, heightHigh, heightMinBlendLow, heightMaxBlendHigh, TerrainBiome.TypeToIndex(layer.BiomeTexture));
                break;
            case 2: 
                MapManager.PaintHeight(LandLayers.Alpha, heightLow, heightHigh, layer.AlphaTexture);
                break;
            case 3: 
                MapManager.PaintHeight(LandLayers.Topology, heightLow, heightHigh, layer.TopologyTexture, layer.TopologyLayer);
                break;
        }
    }
}