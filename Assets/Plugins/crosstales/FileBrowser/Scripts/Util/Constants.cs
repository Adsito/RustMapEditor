namespace Crosstales.FB.Util
{
    ...
    public abstract class Constants : Common.Util.BaseConstants
    {
        ...
        public const string ASSET_VERSION = "2019.2.4";

        /// <summary>Build number of the asset.</summary>
        public const int ASSET_BUILD = 20190410;
        ...
        public static readonly System.DateTime ASSET_CHANGED = new System.DateTime(2019, 4, 10);

        /// <summary>URL of the PRO asset in UAS.</summary>
        public const string ASSET_PRO_URL = "https://goo.gl/W7CHcN";
